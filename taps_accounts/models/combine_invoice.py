...
class CombineInvoice(models.Model):
    ...
    sc_no = fields.Char(string='SC NO.', store=True, readonly=False)
    sc_date = fields.Date(string='SC Date', store=True, readonly=False)
...
class CustomerInvoice(models.AbstractModel):
    _name = 'report.taps_accounts.report_cus_invoice'
    _description = 'Customer Invoice'     
...
class PackingList(models.AbstractModel):
    _name = 'report.taps_accounts.report_packing_list'
...
class DeliveryChallan(models.AbstractModel):
    _name = 'report.taps_accounts.report_delivery_challan'
...
class TruckReceipt(models.AbstractModel):
    _name = 'report.taps_accounts.report_truck_receipt'
    _description = 'Truck Receipt'     
...
class BillofExchange(models.AbstractModel):
    _name = 'report.taps_accounts.report_bill_of_exchange'
...
class SalesContract(models.AbstractModel):
    _name = 'report.taps_accounts.report_sales_contract'

...
class FinalActionTaken(models.Model):
    _name = 'hr.grievance.final.action.taken'
    _description = 'Grievance Final Action Taken'
    ...
    def copy(self, default=None):
        ...
        return super(FinalActionTaken, self).copy(default=default)
# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'views/employee_grade_category.xml',
        'views/employee_team_allocation.xml',
        'views/employee_trainee_grade.xml',
        ...
        'reports/kpi_goal_q2.xml',
        'reports/kpi_goal_q3.xml',
        'reports/kpi_goal_q4.xml',

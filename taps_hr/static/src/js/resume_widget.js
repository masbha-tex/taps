odoo.define('taps_hr.FieldResume', function (require) {
"use strict";
...
var AbstractGroupedOne2ManyRenderer = ListRenderer.extend({
     ...
     * @private
     */
    _renderGroupRow: function (display_name, service_length) {
        return qweb.render(this.groupTitleTemplate, {

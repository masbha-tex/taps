...
class IncrementPromotionLine(models.Model):
    ...
    new_gross = fields.Float(string='New Gross',readonly=False, compute='_compute_salary_breakdown', tracking=True, store=True)
    basic = fields.Char('Basic', store=True, readonly=True, compute='_compute_job_id')
    new_basic = fields.Float(string='New Basic',readonly=False, compute='_compute_salary_breakdown', tracking=True, store=True)
    hra = fields.Char('HRA', store=True, readonly=True, compute='_compute_job_id')
    new_hra = fields.Float(string='New House Rent',readonly=False, compute='_compute_salary_breakdown', tracking=True, store=True)
    medical = fields.Char('Medical', store=True, readonly=True, compute='_compute_job_id')
    new_medical = fields.Float(string='New Medical',readonly=False, compute='_compute_salary_breakdown', tracking=True, store=True)
    ...
    new_category = fields.Selection([('staff', 'Staff'),('worker', 'Worker'),('expatriate', 'Expatriate')], 'New Category', compute='onchange_type', tracking=True, readonly=False, store=True, required=True)

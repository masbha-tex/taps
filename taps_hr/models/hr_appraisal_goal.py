...
class HrAppraisalGoal(models.Model):
    ...
    ytd = fields.Char(string="Weight Total", store=True, copy=True, compute='compute_ytd')
    t_ytd = fields.Char(string="Target Total", store=True, copy=True, compute='compute_target_ytd')
    a_ytd = fields.Char(string="ACHV Total", store=True, copy=True, compute='compute_acvd_ytd')
    
    y_ytd = fields.Char(string="Weight YTD",store=True, copy=True, compute='compute_y_ytd')
    y_t_ytd = fields.Char(string="Target YTD",store=True, copy=True, compute='compute_y_target_ytd')
    y_a_ytd = fields.Char(string="ACHV YTD",store=True, copy=True, compute='compute_y_acvd_ytd')   
    ...
    @api.depends('a_apr','a_may','a_jun','a_jul','a_aug','a_sep','a_oct','a_nov','a_dec','a_jan','a_feb','a_mar','t_apr','t_may','t_jun','t_jul','t_aug','t_sep','t_oct','t_nov','t_dec','t_jan','t_feb','t_mar','weight','target','condition')
    def compute_weight(self):
        for app in self:
            if app.condition == 'less':
                if int(app.weight)>=0 and int(app.target)>=0:
                    if int(app.t_apr)>=0 and int(app.a_apr)>=0:
                        a = round(((app.a_apr and app.t_apr/app.a_apr)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_may)>=0 and int(app.a_may)>=0:
                        m = round(((app.a_may and app.t_may/app.a_may)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_jun)>=0 and int(app.a_jun)>=0:
                        j = round(((app.a_jun and app.t_jun/app.a_jun)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_jul)>=0 and int(app.a_jul)>=0:
                        jl = round(((app.a_jul and app.t_jul/app.a_jul)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_aug)>=0 and int(app.a_aug)>=0:
                        au = round(((app.a_aug and app.t_aug/app.a_aug)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_sep)>=0 and int(app.a_sep)>=0:
                        se = round(((app.a_sep and app.t_sep/app.a_sep)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_oct)>=0 and int(app.a_oct)>=0:
                        oc = round(((app.a_oct and app.t_oct/app.a_oct)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_nov)>=0 and int(app.a_nov)>=0:
                        no = round(((app.a_nov and app.t_nov/app.a_nov)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_dec)>=0 and int(app.a_dec)>=0:
                        de = round(((app.a_dec and app.t_dec/app.a_dec)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_jan)>=0 and int(app.a_jan)>=0:
                        ja = round(((app.a_jan and app.t_jan/app.a_jan)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_feb)>=0 and int(app.a_feb)>=0:
                        fe = round(((app.a_feb and app.t_feb/app.a_feb)*int(app.weight))+0.01999)
                    ...
                    if int(app.t_mar)>=0 and int(app.a_mar)>=0:
                        ma = round(((app.a_mar and app.t_mar/app.a_mar)*int(app.weight))+0.01999)

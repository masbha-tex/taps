...
class HrPayslipsss(models.Model):
    ...
    basic_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    hra_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    medical_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    ot_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    arrear_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    att_bonus_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    convence_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    food_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    tiffin_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    snacks_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    car_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    others_alw_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    incentive_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    pf_empr_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    pf_empe_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    rpf_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    ait_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    basic_absent_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)
    gross_absent_wage = fields.Monetary(compute='_compute_basic_net', store=True, copy=True)

...
class SoRmc(models.AbstractModel):
    _name = 'report.taps_sale.report_so_rmc'
    _inherit = 'report.report_xlsx.abstract'
    _description = 'report for rmc'
    ...
    def generate_xlsx_report(self, workbook, data, m_orders):
        ...
        for item in items:
            ...
            sheet.write(0, 0, "PI NO", column_style)
            sheet.write(0, 1, "OA NO", column_style)
            sheet.write(0, 2, "OA DATE", column_style)
            sheet.write(0, 3, "CUSTOMER NAME", column_style)
            sheet.write(0, 4, "SALESPERSON", column_style)
            sheet.write(0, 5, "ITEM", column_style)
            sheet.write(0, 6, "PRODUCT", column_style)
            sheet.write(0, 7, "SLIDER CODE", column_style)
            sheet.write(0, 8, "FINISH", column_style)
            sheet.write(0, 9, "SHADE", column_style)
            sheet.write(0, 10, "TOP & BOTTOM", column_style)
            sheet.write(0, 11, "SIZE", column_style)
            sheet.write(0, 12, "ORDER QTY", column_style)
            sheet.write(0, 13, "UNIT PRICE", column_style)
            
            sheet.write(0, 14, "Slider(rm)", column_style)
            sheet.write(0, 15, "Consumption", column_style)
            sheet.write(0, 16, "Price", column_style)
            sheet.write(0, 17, "Cost", column_style)
            
            sheet.write(0, 18, "Tape(rm)", column_style)
            sheet.write(0, 19, "Consumption", column_style)
            sheet.write(0, 20, "Price", column_style)
            sheet.write(0, 21, "Cost", column_style)
            
            sheet.write(0, 22, "Wire(rm)", column_style)
            sheet.write(0, 23, "Consumption", column_style)
            sheet.write(0, 24, "Price", column_style)
            sheet.write(0, 25, "Cost", column_style)
            
            sheet.write(0, 26, "Top(rm)", column_style)
            sheet.write(0, 27, "Consumption", column_style)
            sheet.write(0, 28, "Price", column_style)
            sheet.write(0, 29, "Cost", column_style)
            
            sheet.write(0, 30, "Bottom(rm)", column_style)
            sheet.write(0, 31, "Consumption", column_style)
            sheet.write(0, 32, "Price", column_style)
            sheet.write(0, 33, "Cost", column_style)
            
            sheet.write(0, 34, "Pinbox(rm)", column_style)
            sheet.write(0, 35, "Consumption", column_style)
            sheet.write(0, 36, "Price", column_style)
            sheet.write(0, 37, "Cost", column_style)
            
            sheet.write(0, 38, "Taffeta Cost", column_style)
            
            sheet.write(0, 39, "Dyeing Cost", column_style)
            sheet.write(0, 40, "Dipping Cost", column_style)
            sheet.write(0, 41, "Plating/Painting Cost", column_style)
            
            sheet.write(0, 42, "ORDER VALUE", column_style)
            sheet.write(0, 43, "RMC", column_style)
            sheet.write(0, 44, "PERCENT", column_style)

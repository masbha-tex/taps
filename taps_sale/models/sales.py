...
class SaleOrder(models.Model):
    ...
    buyer_name = fields.Selection([
        ...
        ('AMAZON','AMAZON'),
        ('ANTERGO','ANTERGO'),
        ('AP BIANCHI','AP BIANCHI'),
        ('APEX','APEX'),
        ('APINDER','APINDER'),
        ('ARDENE','ARDENE'),
        ('ARVIND','ARVIND'),
        ('ASOS','ASOS'),
        ('ATLAS FORMEN','ATLAS FORMEN'),
        ('AVON','AVON'),
        ('BARUCA','BARUCA'),
        ('BCBG','BCBG'),
        ('BEALLS','BEALLS'),
        ('BEBE','BEBE'),
        ('BEBE CLOTHING','BEBE CLOTHING'),
        ('BELK','BELK'),
        ('BENTEX','BENTEX'),
        ('BERSHKA','BERSHKA'),
        ...
        ('BIG BAZAR','BIG BAZAR'),
        ('BMW','BMW'),
        ('BOI TRADING','BOI TRADING'),
        ('BOM BOM JEANS','BOM BOM JEANS'),
        ('Bonmarche Ltd','Bonmarche Ltd'),
        ('BONPRIX','BONPRIX'),
        ('BOOHOO','BOOHOO'),
        ('BOSCOV','BOSCOV'),
        ('BOSSLY','BOSSLY'),
        ('BOYS GROUP','BOYS GROUP'),
        ('BRAND PRO','BRAND PRO'),
        ('BUFFALO','BUFFALO'),
        ('BURTON','BURTON'),
        ('C & A','C & A'),
        ...
        ('CHAAN RAY','CHAAN RAY'),
        ('CHAPS','CHAPS'),
        ('CHIC PARISIEN','CHIC PARISIEN'),
        ('CHICCO','CHICCO'),
        ('CHICOREE','CHICOREE'),
        ('CISALFA','CISALFA'),
        ('CLOUD TAIL','CLOUD TAIL'),
        ('COFRA','COFRA'),
        ('COMPLICE','COMPLICE'),
        ('CONCORD VENTURE','CONCORD VENTURE'),
        ('COSTCO','COSTCO'),
        ('CRT FW 19','CRT FW 19'),
        ...
        ('DELSYS','DELSYS'),
        ('DENALI','DENALI'),
        ('DESIGN POD','DESIGN POD'),
        ('DEWHIRST','DEWHIRST'),
        ('Diaz','Diaz'),
        ('DICE GROUP','DICE GROUP'),
        ('DISTRI CENTER','DISTRI CENTER'),
        ('DIVERSE','DIVERSE'),
        ('DKNY','DKNY'),
        ('DONGYI','DONGYI'),
        ('D-TEX','D-TEX'),
        ('DUNNES','DUNNES'),
        ('EASTERN SOURCING','EASTERN SOURCING'),
        ('EASYBUY','EASYBUY'),
        ('ECI','ECI'),
        ('EDENROPE','EDENROPE'),
        ('Enamor','Enamor'),
        ('EPO','EPO'),
        ('ESPRIT','ESPRIT'),
        ('ETC CREATIONS- NIGERIA','ETC CREATIONS- NIGERIA'),
        ('ETOS','ETOS'),
        ('EUROCENTRA(ALDI)','EUROCENTRA(ALDI)'),
        ('EUROPETEX','EUROPETEX'),
        ('EVANTI','EVANTI'),
        ('FALABELLA','FALABELLA'),
        ('FAM','FAM'),
        ('FAM BRAND','FAM BRAND'),
        ('FANATICS UK','FANATICS UK'),
        ('FASHION DEPOT','FASHION DEPOT'),
        ('FASHION LINQ','FASHION LINQ'),
        ('FASHION NOVA','FASHION NOVA'),
        ('FASHION UK','FASHION UK'),
        ('FCE','FCE'),
        ('FILA','FILA'),
        ('FLIPKART','FLIPKART'),
        ('FORTUNEX','FORTUNEX'),
        ...
        ('JAPANESE','JAPANESE'),
        ('JC PENNEY','JC PENNEY'),
        ('J-CRAFT/KENVELO','J-CRAFT/KENVELO'),
        ('JEANS PLUS LTD','JEANS PLUS LTD'),
        ('JEANS FRITZ','JEANS FRITZ'),
        ('JEASCO','JEASCO'),
        ('JENIOLOGIE','JENIOLOGIE'),
        ('JENNYFER','JENNYFER'),
        ('JJ SPORTS','JJ SPORTS'),
        ('JJXX','JJXX'),
        ('JOMO FASHION','JOMO FASHION'),
        ('JORDAN CRAIG','JORDAN CRAIG'),
        ('JULES','JULES'),
        ('JUNE INTERNATIOANL','JUNE INTERNATIOANL'),
        ('KAISER(OTTO)','KAISER(OTTO)'),
        ('KAPPA','KAPPA'),
        ('Kappahl','Kappahl'),
        ('KAUFLAND','KAUFLAND'),
        ('KAZO','KAZO'),
        ...
        ('KRAYONS','KRAYONS'),
        ('KSA','KSA'),
        ('KyotodaiWa','KyotodaiWa'),
        ('LACHMI INT','LACHMI INT'),
        ('LA-HALLE','LA-HALLE'),
        ('LAPOLO','LAPOLO'),
        ('LC WAIKIKI','LC WAIKIKI'),
        ('LEE & WRANGLER','LEE & WRANGLER'),
        ('LEE COPPER','LEE COPPER'),
        ('LEFTIES','LEFTIES'),
        ('LERROS','LERROS'),
        ('LIDL','LIDL'),
        ('Lifestyle','Lifestyle'),
        ('LINDEX','LINDEX'),
        ('LINN DITLEVESEN','LINN DITLEVESEN'),
        ('LISSOME','LISSOME'),
        ('LONSDALE','LONSDALE'),
        ('LOVEGEN','LOVEGEN'),
        ('LPP','LPP'),
        ...
        ('MAYORAL','MAYORAL'),
        ('MEB','MEB'),
        ('Medira sourcing','Medira sourcing'),
        ('MEIJER','MEIJER'),
        ('Melon Fashion','Melon Fashion'),
        ('METRO','METRO'),
        ('MG HOLLAND','MG HOLLAND'),
        ('MISS ETAM','MISS ETAM'),
        ...
        ('OPB','OPB'),
        ('ORCHESTRA','ORCHESTRA'),
        ('ORIGINAL MARINE','ORIGINAL MARINE'),
        ('OSTIN','OSTIN'),
        ('OUTERSTYFF','OUTERSTYFF'),
        ('OVS','OVS'),
        ('P&C','P&C'),
        ('PAPER DENIM','PAPER DENIM'),
        ('PEARLTEX','PEARLTEX'),
        ('Peloton','Peloton'),
        ('PENMANS','PENMANS'),
        ('PERFOIS','PERFOIS'),
        ...
        ('Polo Club','Polo Club'),
        ('PORFOIS','PORFOIS'),
        ('Premier UK','Premier UK'),
        ('PRENTAL KIDS','PRENTAL KIDS'),
        ('PRIMARK','PRIMARK'),
        ('PROJEK RAW','PROJEK RAW'),
        ('PROMOD','PROMOD'),
        ('PULL & BEAR','PULL & BEAR'),
        ('PUMA','PUMA'),
        ('QVC','QVC'),
        ...
        ('ROBI DI KAPPA','ROBI DI KAPPA'),
        ('ROF','ROF'),
        ('ROSIN','ROSIN'),
        ('ROSS','ROSS'),
        ('ROSS Q4','ROSS Q4'),
        ('ROSSINI TECH','ROSSINI TECH'),
        ('RRG','RRG'),
        ('SAINSBURY','SAINSBURY'),
        ...
        ('SELA','SELA'),
        ('SHAWS','SHAWS'),
        ('SIDCO TEX LTD','SIDCO TEX LTD'),
        ('SIGGI','SIGGI'),
        ('SIGNET','SIGNET'),
        ('SIPLEC','SIPLEC'),
        ('SMITH','SMITH'),
        ('SMITH TEXSTAR','SMITH TEXSTAR'),
        ('SONAE','SONAE'),
        ('SOUTHPOLE','SOUTHPOLE'),
        ('SPORTS DIRECT-EVERLAST','SPORTS DIRECT-EVERLAST'),
        ('SPRINGFIELD','SPRINGFIELD'),
        ('SR INTERNATIONAL','SR INTERNATIONAL'),
        ('SRK','SRK'),
        ('STDM','STDM'),
        ('STI','STI'),
        ('STRADIVARIUS','STRADIVARIUS'),
        ('STREET ONE','STREET ONE'),
        ('STYLE BERRY','STYLE BERRY'),
        ('STYLETEX','STYLETEX'),
        ('SUN','SUN'),
        ('SUNRISE USA','SUNRISE USA'),
        ('SUPERDRY','SUPERDRY'),
        ('SUPON','SUPON'),
        ('Synergies','Synergies'),
        ('TAC','TAC'),
        ('TAHARI','TAHARI'),
        ('Tahari Denim','Tahari Denim'),
        ('TAILORED IMAGE','TAILORED IMAGE'),
        ('TAKKO','TAKKO'),
        ('TALLY WEIJL','TALLY WEIJL'),
        ('TAO','TAO'),
        ('Target','Target'),
        ('TARGET USA','TARGET USA'),
        ('TATA TRENT','TATA TRENT'),
        ('TCL','TCL'),
        ('Tebram GmbH','Tebram GmbH'),
        ('TECHNO DESIGN','TECHNO DESIGN'),
        ('TEDI','TEDI'),
        ('Tendam','Tendam'),
        ('TESCO','TESCO'),
        ('Tesco Dimension','Tesco Dimension'),
        ('TEXEBO','TEXEBO'),
        ('TIME OUT','TIME OUT'),
        ('TJ Maxx','TJ Maxx'),
        ('TJX','TJX'),
        ...
        ('TWL','TWL'),
        ('UFO','UFO'),
        ('UFO ARDENE','UFO ARDENE'),
        ('USA','USA'),
        ('USA DANIEL','USA DANIEL'),
        ('VERO MODA','VERO MODA'),
        ...
        ('WARWICK','WARWICK'),
        ('WAVEN','WAVEN'),
        ('WEAR FIRST','WEAR FIRST'),
        ('WILDCRAFT','WILDCRAFT'),
        ('WIND BREAKER','WIND BREAKER'),
        ('WOLVERINE','WOLVERINE'),
        ('WOOLWORTHS','WOOLWORTHS'),
        ('ZARA','ZARA'),
        ('ZOLLA','ZOLLA')],string='Buyer Name')
        ...
        for products in self.order_line:
            ...
            for lines in bom_lines:
                ...
                for sub_lines in bom_sub_lines:
                    ...
                    if sub_bom:
                        sub_qty = sub_lines.product_qty * lines.product_qty

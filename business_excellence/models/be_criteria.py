...
class Criteria(models.Model):
    ...
    title_ids = fields.One2many('business.excellence.title', 'criteria_id', string='Task')
    color = fields.Integer('Color Index')
    

    _sql_constraints = [
        ('name_uniq', 'unique(name)', 'The name of the Business Excellence Scope must be unique!'),]      

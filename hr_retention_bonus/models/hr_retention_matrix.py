...
class RetentionBonusMatrix(models.Model):
    _name = 'hr.retention.matrix'
    _description = 'Retention Bonus Matrix'
    ...
    def copy(self, default=None):
        ...
        return super(RetentionBonusMatrix, self).copy(default=default)
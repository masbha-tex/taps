odoo.define('taps_lms.barcode_scanner', function (require) {
"use strict";
...
var BarcodeScanner = AbstractAction.extend({
    ...
    _callServer: function () {
        ...
        return ajax.rpc("/taps_lms/lms_keepalive", {});
    },

});

core.action_registry.add('taps_lms_barcode_scanner', BarcodeScanner);

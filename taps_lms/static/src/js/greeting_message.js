...
var GreetingMessage = AbstractAction.extend({
    ...
    init: function(parent, action) {
        ...
        if(!action.attendance) {
            ...
            this.getSession().user_has_group('hr_attendance.group_hr_attendance_user').then(function(has_group) {
                if(has_group) {
                    ...
                    self.next_action = 'taps_lms.action_my_attendances';
                }
            });
            return;
        }

        this.next_action = action.next_action || 'taps_lms.action_my_attendances';
        ...
        // this.docs = action.docs;
        // this.datas = action.datas;
        // this.alldays = action.alldays;
        
        // this.officein = action.officein;
        // this.intime = action.intime;
        // this.inflag = action.inflag;
        // this.officeout = action.officeout;
        // this.outtime = action.outtime;
        // this.outflag = action.outflag;
        // this.othours = action.othours;  
        // this.lstmonths_data = action.lstmonths_data;
    },

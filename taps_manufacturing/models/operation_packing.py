...
class OperationDetails(models.Model):
    ...
    slidercodesfg = fields.Char(string='Slider Code', related='sale_order_line.slidercodesfg', store=True, readonly=True)
    finish = fields.Char(string='Finish', related='sale_order_line.finish', store=True, readonly=True)
    shade = fields.Char(string='Shade', related='sale_order_line.shade', store=True, readonly=True)
    shade_ref = fields.Char(string='Shade Ref.', related='sale_order_line.shade_ref', store=True, readonly=True)
  
    sizein = fields.Char(string='Size (Inch)', related='sale_order_line.sizein', store=True, readonly=True)
    sizecm = fields.Char(string='Size (CM)', related='sale_order_line.sizecm', store=True, readonly=True)
    sizemm = fields.Char(string='Size (MM)', related='sale_order_line.sizemm', store=True, readonly=True)
    ...
    top = fields.Char(string='Top', related='sale_order_line.ptopfinish', store=True, readonly=True)
    bottom = fields.Char(string='Bottom', related='sale_order_line.pbotomfinish', store=True)
    pinbox = fields.Char(string='Pin-Box', related='sale_order_line.ppinboxfinish', store=True)

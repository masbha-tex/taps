odoo.define('taps_manufacturing.ClientAction', function (require) {
'use strict';
...
var ClientAction = AbstractAction.extend({
    ...
    init: function (parent, action) {
        ...
        this.searchModelConfig.modelName = 'packing.report';
    },
    ...
    //         args: ['taps_manufacturing', 'mrp_mps_search_view'],
    ...
    _createProduct: function () {
        ...
        this.mutex.exec(function () {
            return self.do_action('taps_manufacturing.action_packing_production_report_form_view', {
    ...
    _reloadContent: function () {
        ...
        return this._getState().then(function () {
            var $content = $(QWeb.render('mrp_mps_copy', {
                widget: {
...
core.action_registry.add('packing_mps_client_action', ClientAction);

...
class MailTemplate(models.Model):
    ...
    #     for lang, (_template, _template_res_ids) in self._classify_per_lang(res_ids).items():
    ...
    #                     result[res_id]["body_html"] = self_with_lang._render_template_postprocess({res_id: body_html})[res_id]
    #                     result[res_id]["body"] = tools.html_sanitize(result[res_id]["body_html"])
